...
import com.i.common.attendance.databinding.RowItemNewDealerSurveyBinding
import com.i.common.attendance.network.response.PartyRemarkDto

class NewDealerSurveyAdapter : ListAdapter<PartyRemarkDto, NewDealerSurveyAdapter.ViewHolder>(DiffCallback()) {

    inner class ViewHolder(
        private val binding: RowItemNewDealerSurveyBinding
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        return ViewHolder(
            RowItemNewDealerSurveyBinding.inflate(
