...
object DrawerMenuConfig {
    ...
    val menuItemLabel: Map<MenuItem, Int> = mapOf(
        ...
        MenuItem.NEW_DEALER_WISE_TARGET_ENTRY to R.string.toolbar_title_new_dealer_wise_report_entry,
    ...
    private val unnatiItems = listOf(
        ...
        //MenuItem.NEW_DEALER_WISE_TARGET_ENTRY,
