...
import com.i.common.attendance.ui.home.touragendatracking.adapter.SelectStateAdapter

class SelectStateBottomSheetFragment : BottomSheetDialogFragment() {

    private lateinit var binding: BottomSheetFragmentSelectStateBinding
    private lateinit var selectActivityPlanAdapter: SelectStateAdapter

    private var planForList: ArrayList<GetState> = arrayListOf()
    private var fullList: List<GetState> = emptyList()


    companion object {
        private const val ARG_LIST = "activity_plan_list"

        fun newInstance(list: List<GetState>): SelectStateBottomSheetFragment {
            return SelectStateBottomSheetFragment().apply {
    ...
    private var dismissCallback: ((GetState) -> Unit)? = null

    fun setDismissCallback(callback: (GetState) -> Unit) {
    ...
    private fun setUpRecyclerView() = with(binding) {
        ...
        selectActivityPlanAdapter = SelectStateAdapter { selectedStatus ->
