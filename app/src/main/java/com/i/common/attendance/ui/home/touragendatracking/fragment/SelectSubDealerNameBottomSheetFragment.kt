...
import com.i.common.attendance.ui.home.touragendatracking.adapter.SelectSubDealerNameAdapter

class SelectSubDealerNameBottomSheetFragment : BottomSheetDialogFragment() {

    private lateinit var binding: BottomSheetFragmentSelectStateBinding
    private lateinit var selectActivityPlanAdapter: SelectSubDealerNameAdapter

    private var planForList: ArrayList<TourAgendaTrackingSubDealerName> = arrayListOf()
    private var fullList: List<TourAgendaTrackingSubDealerName> = emptyList()


    companion object {
        private const val ARG_LIST = "activity_plan_list"

        fun newInstance(list: List<TourAgendaTrackingSubDealerName>): SelectSubDealerNameBottomSheetFragment {
            return SelectSubDealerNameBottomSheetFragment().apply {
    ...
    private var dismissCallback: ((TourAgendaTrackingSubDealerName) -> Unit)? = null

    fun setDismissCallback(callback: (TourAgendaTrackingSubDealerName) -> Unit) {
    ...
    private fun setUpRecyclerView() = with(binding) {
        ...
        selectActivityPlanAdapter = SelectSubDealerNameAdapter { selectedStatus ->
