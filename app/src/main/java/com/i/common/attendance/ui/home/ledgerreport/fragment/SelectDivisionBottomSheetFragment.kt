...
import com.i.common.attendance.ui.home.ledgerreport.adapter.SelectDivisionAdapter

class SelectDivisionBottomSheetFragment : BottomSheetDialogFragment() {

    private lateinit var binding: BottomSheetFragmentSelectDistrictBinding
    private lateinit var selectDistrictAdapter: SelectDivisionAdapter

    private var fullList: List<GetDivision> = emptyList()
    private var districtList: ArrayList<GetDivision> = arrayListOf()

    companion object {
        private const val ARG_LIST = "district_for_list"

        fun newInstance(list: List<GetDivision>): SelectDivisionBottomSheetFragment {
            return SelectDivisionBottomSheetFragment().apply {
    ...
    private var dismissCallback: ((GetDivision) -> Unit)? = null

    fun setDismissCallback(callback: (GetDivision) -> Unit) {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        setUpRecyclerView()
        manageSearchView()
        binding.txtViewSelect.text = "Select Division"
    }

    private fun setUpRecyclerView() = with(binding) {

        selectDistrictAdapter = SelectDivisionAdapter { selectedStatus ->
    ...
    private fun filterList(query: String?) {
        ...
        val filteredList = fullList.filter {
            it.BranchName?.contains(query, ignoreCase = true) == true
        }
