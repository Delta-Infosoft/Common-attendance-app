...
import com.i.common.attendance.ui.home.tourvoucher.adapter.SelectActivityPlanAdapter

class SelectActivityPlanBottomSheetFragment : BottomSheetDialogFragment() {

    private lateinit var binding: BottomSheetFragmentSelectEmployeeBinding
    private lateinit var selectActivityPlanAdapter: SelectActivityPlanAdapter
    ...
    companion object {
        ...
        fun newInstance(list: List<DropdownItem>): SelectActivityPlanBottomSheetFragment {
            return SelectActivityPlanBottomSheetFragment().apply {
    ...
    private fun setUpRecyclerView() = with(binding) {
        ...
        selectActivityPlanAdapter = SelectActivityPlanAdapter { selectedStatus ->
