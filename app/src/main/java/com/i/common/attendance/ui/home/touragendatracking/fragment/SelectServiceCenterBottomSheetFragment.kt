...
import com.i.common.attendance.ui.home.touragendatracking.adapter.SelectServiceCenterAdapter

class SelectServiceCenterBottomSheetFragment : BottomSheetDialogFragment() {

    private lateinit var binding: BottomSheetFragmentSelectStateBinding
    private lateinit var selectActivityPlanAdapter: SelectServiceCenterAdapter

    private var planForList: ArrayList<TourAgendaTrackingServiceCenter> = arrayListOf()
    private var fullList: List<TourAgendaTrackingServiceCenter> = emptyList()


    companion object {
        private const val ARG_LIST = "activity_plan_list"

        fun newInstance(list: List<TourAgendaTrackingServiceCenter>): SelectServiceCenterBottomSheetFragment {
            return SelectServiceCenterBottomSheetFragment().apply {
    ...
    private var dismissCallback: ((TourAgendaTrackingServiceCenter) -> Unit)? = null

    fun setDismissCallback(callback: (TourAgendaTrackingServiceCenter) -> Unit) {
    ...
    private fun setUpRecyclerView() = with(binding) {
        ...
        selectActivityPlanAdapter = SelectServiceCenterAdapter { selectedStatus ->
