...
import com.i.common.attendance.ui.home.ledgerreport.adapter.SelectDistrictAdapter
...
class SelectDistrictBottomSheetFragment : BottomSheetDialogFragment() {
    ...
    private var fullList: List<GetDistrict> = emptyList()
    private var districtList: ArrayList<GetDistrict> = arrayListOf()

    companion object {
        private const val ARG_LIST = "district_for_list"

        fun newInstance(list: List<GetDistrict>): SelectDistrictBottomSheetFragment {
    ...
    private var dismissCallback: ((GetDistrict) -> Unit)? = null

    fun setDismissCallback(callback: (GetDistrict) -> Unit) {
