...
import com.i.common.attendance.databinding.RowItemNewDealerAppointmentBinding
import com.i.common.attendance.network.response.PartyRemarkDto

class NewDealerAppointmentAdapter : ListAdapter<PartyRemarkDto, NewDealerAppointmentAdapter.ViewHolder>(DiffCallback()) {

    inner class ViewHolder(
        private val binding: RowItemNewDealerAppointmentBinding
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        return ViewHolder(
            RowItemNewDealerAppointmentBinding.inflate(
