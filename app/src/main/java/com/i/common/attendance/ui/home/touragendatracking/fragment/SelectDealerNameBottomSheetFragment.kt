...
import com.i.common.attendance.ui.home.touragendatracking.adapter.SelectDealerNameAdapter

class SelectDealerNameBottomSheetFragment : BottomSheetDialogFragment() {

    private lateinit var binding: BottomSheetFragmentSelectStateBinding
    private lateinit var selectActivityPlanAdapter: SelectDealerNameAdapter

    private var planForList: ArrayList<TourAgendaTrackingDealerName> = arrayListOf()
    private var fullList: List<TourAgendaTrackingDealerName> = emptyList()


    companion object {
        private const val ARG_LIST = "activity_plan_list"

        fun newInstance(list: List<TourAgendaTrackingDealerName>): SelectDealerNameBottomSheetFragment {
            return SelectDealerNameBottomSheetFragment().apply {
    ...
    private var dismissCallback: ((TourAgendaTrackingDealerName) -> Unit)? = null

    fun setDismissCallback(callback: (TourAgendaTrackingDealerName) -> Unit) {
    ...
    private fun setUpRecyclerView() = with(binding) {
        ...
        selectActivityPlanAdapter = SelectDealerNameAdapter { selectedStatus ->
