...
import com.i.common.attendance.ui.home.tourvoucher.adapter.SelectTravelByAdapter

class SelectTravelByBottomSheetFragment : BottomSheetDialogFragment() {

    private lateinit var binding: BottomSheetFragmentSelectTravelByBinding
    private lateinit var selectTravelByAdapter: SelectTravelByAdapter

    private var fullList: List<TravelingByItem> = emptyList()
    private var districtList: ArrayList<TravelingByItem> = arrayListOf()

    companion object {
        private const val ARG_LIST = "district_for_list"

        fun newInstance(list: List<TravelingByItem>): SelectTravelByBottomSheetFragment {
            return SelectTravelByBottomSheetFragment().apply {
    ...
    private var dismissCallback: ((TravelingByItem) -> Unit)? = null

    fun setDismissCallback(callback: (TravelingByItem) -> Unit) {
    ...
    private fun setUpRecyclerView() = with(binding) {
        ...
        selectTravelByAdapter = SelectTravelByAdapter { selectedStatus ->
